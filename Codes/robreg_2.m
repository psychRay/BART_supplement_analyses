...
%%
    %% ====================================================================================================
    % for：condition-wise one-sample activation of audlts and children(成人和儿童在各条件下的激活)
    ...
    % ====================================================================================================
    % for：condition-wise contrasts btw adults and children(成人和儿童在各条件下的比较)
    for n_cons=1:numel(cons)
...
EXPT.subjects  = subject_names;
    ...
    % ====================================================================================================
    % extract covariates from table of covariates, matching the current subjects group(从covariates表格中
    % 提取与当前组被试匹配的covariates)
    T = readtable(tab_cov);
    columnName = 'ID';
...
%%
    %% ====================================================================================================
    % for：condition-wise one-sample activation of each age group in children(各年龄组儿童在各条件下的激活)
